...
export const event = {
  ...
  timeLabel: 'الخامسة والنصف مساءً',
...
export const timeline = [
  { time: '17:00 - 17:30', title: 'تجمع النساء', detail: 'قاعة النساء' },
  { time: '17:00 - 17:15', title: 'تجمع أهل العروس - رجال', detail: 'قاعة الرجال' },
  { time: '17:15 - 17:30', title: 'تجمع أهل العريس - رجال', detail: 'أمام قاعة الرجال' },
  { time: '17:30', title: 'بداية الجاهة - الحفل', detail: '' },
  { time: '19:30', title: 'نهاية الحفل', detail: '' },
] as const;
...
export const contacts = [
  ...
  { name: 'علي الجلامنة', role: 'والد العروس ', phone: '+962795534336' },
] as const;
...
export const ui = {
  ...
  details: {
    ...
    lede: 'كل ما تحتاجونه لهذه الليلة في مكان واحد.',
    date: 'التاريخ',
    time: 'الوقت',
    place: 'المكان',
